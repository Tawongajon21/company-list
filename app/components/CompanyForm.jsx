...
import { addCompany } from '../server-actions/addCompany'
function CompanyForm() {
  return (
    <form action={addCompany} className="mb-6">
    <div className="mb-4">
        <label htmlFor="brand" className="block text-white mb-2">Company</label>
        <input 
            type="text"
            id="name"
            name="name"
    ...
    <div className="mb-4">
        <label htmlFor="model" className="block text-white mb-2">Industry</label>
        <input 
            type="text"
            id="industry"
            name="industry"
